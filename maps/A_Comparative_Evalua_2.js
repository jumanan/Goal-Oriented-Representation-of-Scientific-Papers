...
var cy = cytoscape({
	...
	elements: {
		nodes: [
			{ data: { id:'t4', name: 'similarity metrics' }, css: {'width' : '76', 'height': '10'}, classes:'task'},
			{ data: { id:'t1', name: 'semantic interoperability among heterogeneous data' }, css: {'width' : '204', 'height': '10'}, classes:'task'},
			{ data: { id:'t2', name: 'string similarity metrics' }, css: {'width' : '104', 'height': '10'}, classes:'task'},
			{ data: { id:'t0', name: 'Ontology alignment' }, css: {'width' : '76', 'height': '10'}, classes:'task'},
			{ data: { id:'t3', name: 'analyze naming variations' }, css: {'width' : '104', 'height': '10'}, classes:'task'}
